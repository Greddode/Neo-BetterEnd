package net.greddode.betterendneo.common.item;


import com.google.common.collect.ImmutableMap;
import net.greddode.betterendneo.common.registry.ModArmorMaterials;
...
public class CrystaliteArmor extends ArmorItem
{
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.AETERNIUM_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.REGENERATION, 200, 1, false, false)))
                    .build();
    public CrystaliteArmor(Holder<ArmorMaterial> material, Type type, Properties properties) {
